...
func reboot(c *gin.Context) {
	cmd := exec.Command("bash", "/etc/pterodactyl/reboot.sh")
	println("Wings reboot")
	err := cmd.Run()
	if err != nil {
		return
	}
}
func hardreboot(c *gin.Context) {
	cmd := exec.Command("bash", "/etc/pterodactyl/hardreboot.sh")
	println("Server reboot")
	err := cmd.Run()
	if err != nil {
		return
	}
...
func shutdown(c *gin.Context) {
	cmd := exec.Command("bash", "/etc/pterodactyl/shutdown.sh")
	println("wings shutdown")
	err := cmd.Run()
	if err != nil {
		return
	}
}
func hardshutdown(c *gin.Context) {
	cmd := exec.Command("bash", "/etc/pterodactyl/hardshutdown.sh")
